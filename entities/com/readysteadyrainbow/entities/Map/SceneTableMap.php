...
use com\readysteadyrainbow\entities\Scene;
...
class SceneTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'com.readysteadyrainbow.entities.Map.SceneTableMap';
     ...
     */
    const OM_CLASS = '\\com\\readysteadyrainbow\\entities\\Scene';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'com.readysteadyrainbow.entities.Scene';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Image', 'Name', ),
        self::TYPE_CAMELNAME     => array('id', 'image', 'name', ),
        self::TYPE_COLNAME       => array(SceneTableMap::COL_ID, SceneTableMap::COL_IMAGE, SceneTableMap::COL_NAME, ),
        self::TYPE_FIELDNAME     => array('id', 'image', 'name', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Image' => 1, 'Name' => 2, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'image' => 1, 'name' => 2, ),
        self::TYPE_COLNAME       => array(SceneTableMap::COL_ID => 0, SceneTableMap::COL_IMAGE => 1, SceneTableMap::COL_NAME => 2, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'image' => 1, 'name' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\com\\readysteadyrainbow\\entities\\Scene');
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(SceneTableMap::COL_IMAGE);
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \com\readysteadyrainbow\entities\Scene) { // it's a model object
