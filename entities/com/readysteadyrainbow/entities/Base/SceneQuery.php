...
use com\readysteadyrainbow\entities\Scene as ChildScene;
 ...
 * @method     ChildSceneQuery orderByImage($order = Criteria::ASC) Order by the image column
 ...
 * @method     ChildSceneQuery groupByImage() Group by the image column
 ...
 * @method     ChildScene findOneByImage(string $image) Return the first ChildScene filtered by the image column
 ...
 * @method     ChildScene requireOneByImage(string $image) Return the first ChildScene filtered by the image column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildScene requireOneByName(string $name) Return the first ChildScene filtered by the name column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildScene[]|ObjectCollection findByImage(string $image) Return ChildScene objects filtered by the image column
...
abstract class SceneQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT id, image, name FROM scene WHERE id = :p0';
        try {
    ...
    public function filterByImage($image = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(SceneTableMap::COL_IMAGE, $image, $comparison);
    }
