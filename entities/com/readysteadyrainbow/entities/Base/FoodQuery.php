...
use com\readysteadyrainbow\entities\Food as ChildFood;
use com\readysteadyrainbow\entities\FoodQuery as ChildFoodQuery;
use com\readysteadyrainbow\entities\Map\FoodTableMap;
 ...
 * @method     ChildFoodQuery orderByColour($order = Criteria::ASC) Order by the colour column
 * @method     ChildFoodQuery orderByVersion($order = Criteria::ASC) Order by the version column
 ...
 * @method     ChildFoodQuery groupByColour() Group by the colour column
 * @method     ChildFoodQuery groupByVersion() Group by the version column
 ...
 * @method     ChildFood findOneByColour(string $colour) Return the first ChildFood filtered by the colour column
 * @method     ChildFood findOneByVersion(int $version) Return the first ChildFood filtered by the version column
 ...
 * @method     ChildFood requireOneByColour(string $colour) Return the first ChildFood filtered by the colour column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildFood requireOneByVersion(int $version) Return the first ChildFood filtered by the version column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildFood[]|ObjectCollection findByColour(string $colour) Return ChildFood objects filtered by the colour column
 * @method     ChildFood[]|ObjectCollection findByVersion(int $version) Return ChildFood objects filtered by the version column
...
abstract class FoodQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \com\readysteadyrainbow\entities\Base\FoodQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\com\\readysteadyrainbow\\entities\\Food', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT name, colour, version, id FROM food WHERE id = :p0';
        try {
    ...
    public function filterByColour($colour = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(FoodTableMap::COL_COLOUR, $colour, $comparison);
    }
    ...
    public function filterByVersion($version = null, $comparison = null)
    {
        if (is_array($version)) {
            ...
            if (isset($version['min'])) {
                $this->addUsingAlias(FoodTableMap::COL_VERSION, $version['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($version['max'])) {
                $this->addUsingAlias(FoodTableMap::COL_VERSION, $version['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(FoodTableMap::COL_VERSION, $version, $comparison);
    }
