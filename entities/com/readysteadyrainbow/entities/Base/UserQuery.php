...
use com\readysteadyrainbow\entities\User as ChildUser;
...
abstract class UserQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \com\readysteadyrainbow\entities\Base\UserQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\com\\readysteadyrainbow\\entities\\User', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT id, email FROM user WHERE id = :p0';
        try {
