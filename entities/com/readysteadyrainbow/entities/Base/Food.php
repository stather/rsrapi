...
abstract class Food implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\com\\readysteadyrainbow\\entities\\Map\\FoodTableMap';
    ...
    /**
     * Initializes internal state of com\readysteadyrainbow\entities\Base\Food object.
     */
     ...
     * @return $this|\com\readysteadyrainbow\entities\Food The current object (for fluent API support)
     */
    ...
    public function setColour($v)
    {
        ...
        if ($this->colour !== $v) {
            $this->colour = $v;
            $this->modifiedColumns[FoodTableMap::COL_COLOUR] = true;
        }
    ...
    public function setVersion($v)
    {
        ...
        if ($this->version !== $v) {
            $this->version = $v;
            $this->modifiedColumns[FoodTableMap::COL_VERSION] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : FoodTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : FoodTableMap::translateFieldName('Colour', TableMap::TYPE_PHPNAME, $indexType)];
            $this->colour = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : FoodTableMap::translateFieldName('Version', TableMap::TYPE_PHPNAME, $indexType)];
            $this->version = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : FoodTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 4; // 4 = FoodTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\com\\readysteadyrainbow\\entities\\Food'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(FoodTableMap::COL_COLOUR)) {
            $modifiedColumns[':p' . $index++]  = 'colour';
        }
        if ($this->isColumnModified(FoodTableMap::COL_VERSION)) {
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\com\readysteadyrainbow\entities\Food
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\com\readysteadyrainbow\entities\Food The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(FoodTableMap::COL_COLOUR)) {
            $criteria->add(FoodTableMap::COL_COLOUR, $this->colour);
        }
        if ($this->isColumnModified(FoodTableMap::COL_VERSION)) {
            $criteria->add(FoodTableMap::COL_VERSION, $this->version);
        }
        if ($this->isColumnModified(FoodTableMap::COL_ID)) {
     ...
     * objects.
     *
     * @param      object $copyObj An object of \com\readysteadyrainbow\entities\Food (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \com\readysteadyrainbow\entities\Food Clone of current object.
     * @throws PropelException
     */
